    ...
    try {
      ...
      if (data?.user) {
        ...
        if (!userProfile) {
          ...
          // Redirect based on role - auth context will handle profile loading
          redirectToDashboard()
        }
      }
    } catch (err: any) {
      ...
      if (err.message?.includes('Email not confirmed')) {
        setError('Account not activated. Please check your email for the confirmation link or register again.')
    ...
    <div className="min-h-screen bg-gradient-to-b from-pink-50 via-white to-pink-50 flex items-center justify-center p-4 relative">
      ...
      >
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-gray-900">Welcome to ASHA AI</h1>
          <p className="text-pink-600 font-hindi">आशा AI में आपका स्वागत है</p>
        </div>
        ...
        <Card className="border-pink-100 shadow-lg">
          <CardHeader>
            ...
            <p className="text-center text-sm text-gray-500 font-hindi">
              लॉगिन करें
            </p>
          </CardHeader>
          <CardContent className="space-y-4">
            ...
            <Button
              ...
              disabled={isLoading}
              variant="outline"
              className="w-full border-gray-300 hover:bg-gray-50 py-6 text-lg"
            >
