...
// Keep existing Hindi prompt for compatibility
...
जवाब के नियम:
1. जवाब 40 शब्दों से कम रखें (आवाज की स्पष्टता के लिए)
...
RESPONSE RULES:
1. Keep responses under 40 words (for voice clarity)
...
export const EMERGENCY_RESPONSES = {
  hi: {
    bleeding: 'भारी रक्तस्राव गंभीर हो सकता है। कृपया तुरंत Red Zone बटन दबाएं और लेट जाएं। ASHA दीदी को तुरंत बुलाएं।',
    pain: 'तेज़ दर्द को नज़रअंदाज़ न करें। Red Zone बटन दबाएं। क्या आप मुझे बता सकती हैं दर्द कहाँ है?',
    fever: 'तेज़ बुखार खतरनाक हो सकता है। कृपया ASHA दीदी को बुलाएं या नज़दीकी स्वास्थ्य केंद्र जाएं।',
    unconscious: 'यह इमरजेंसी है! तुरंत 108 पर कॉल करें या नज़दीकी अस्पताल जाएं।',
    no_movement: 'बच्चे का न हिलना चिंता की बात है। कृपया तुरंत डॉक्टर से मिलें।'
  },
  en: {
    bleeding: 'Heavy bleeding can be serious. Please press the Red Zone button immediately and lie down. Call your ASHA worker right away.',
    pain: 'Do not ignore severe pain. Press the Red Zone button. Can you tell me where the pain is?',
    fever: 'High fever can be dangerous. Please call your ASHA worker or go to the nearest health center.',
    unconscious: 'This is an emergency! Call 108 immediately or go to the nearest hospital.',
    no_movement: 'Baby not moving is concerning. Please see a doctor immediately.'
  }
}
